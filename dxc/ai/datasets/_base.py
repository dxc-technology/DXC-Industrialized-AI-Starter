...
def get_data(dataset, display_details=False, save_copy=False):

    """
    >>> data = get_data('iris')
    >>> data = get_data('iris', display_details=True)
    >>> data = get_data('iris', display_details=True. save_copy=True)
